...
import { getMainCoursesSelectContent, getSaladSelectContent, getDesertSelectContent, getDrinkSelectContent } from '../../../fakeGenreService';
      ...
      <Card className='shadow-lg' id="sideBarId">
        <CardBody>
          <Row className="input-group mt-4 ">
            <Col>
            <label for="select-main" className='text-light'>Main Course</label>
                <Select
                id='select-main'
                isClearable={false}
                isMulti
          ...
          <Col>
            <label for="select-salad" className='text-light'>Salad</label>
                <Select
                id='select-salad'
                isClearable={false}
                isMulti
          ...
          <Col>
            <label for="select-desert" className='text-light'>Desert</label>
                <Select
                id='select-desert'
                isClearable={false}
                isMulti
          ...
          <Row className="input-group input-group-sm mb-3 mt-5">
          <Col>
            <label for="select-drink" className='text-light'>Drink</label>
                <Select
                id='select-drink'
                isClearable={false}
                isMulti
